...
import com.accor.asa.commun.reference.metier.RemunerationTypeByTOCachList;
 ...
 * Time: 15:26:11
 */
public class RemunerationTypeByTORefDAO extends RefDAO {

    private static final String ADMIN_SELECT_PROC_NAME  = "ref_selRemunerationTypeByTO";
    private static final String INSERT_PROC_NAME        = "ref_addRemunerationTypeByTO";
    private static final String DELETE_PROC_NAME        = "ref_delRemunerationTypeByTO";
    ...
    /**
     * Retourne la liste des types de remuneration
     * par type offre
     *
     * @param context
     * @param bean
	...
	public List<ParamRefBean> getAdminRefList( Contexte contexte, RefBean bean )
        ...
        try {
            List<ElementWithState> listJointure = (List<ElementWithState>) SQLCallExecuter.getInstance()
                    ...
                    "RemunerationTypeByTORefDAO", "getAdminRefList",
                    ...
                    new SQLResultSetReader() {
                        public Object instanciateFromLine(ResultSet rs) throws SQLException {
                            ...
                            obj.setCode(StringUtils.trimToEmpty(rs.getString("idRemunerationType")));
                            obj.setLibelle(StringUtils.trimToEmpty(rs.getString("libRemunerationType")));
    ...
    /**
     * Update la liste des types de remuneration
     * par type d'offre
     *
     * @param context
     * @param bean
    ...
    protected String getCacheClassName () {
        return RemunerationTypeByTOCachList.class.getName();
    }

    protected CachableInterface getObjectInCache (String codeLangue) {
        return (CachableInterface) CacheManager.getInstance().getObjectInCache(RemunerationTypeByTOCachList.class);
    }
	...
	protected CachableInterface createCacheObject(List<?> data, Contexte contexte) throws TechnicalException, IncoherenceException {
		return new RemunerationTypeByTOCachList((List<ParamRefBean>) data);
	}
