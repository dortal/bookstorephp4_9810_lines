...
import com.accor.asa.commun.reference.metier.ModeReservationByTOCachList;
 ...
 * Time: 15:25:33
 */
public class ModeReservationByTORefDAO extends RefDAO {

    private static final String ADMIN_SELECT_PROC_NAME  = "ref_selReservationModeByTO";
    private static final String INSERT_PROC_NAME        = "ref_addReservationModeByTO";
    private static final String DELETE_PROC_NAME        = "ref_delReservationModeByTO";
    ...
    /**
     * Retourne la liste des modes de reservation
     * par type offre
     *
     * @param context
     * @param bean
	...
	public List<ParamRefBean> getAdminRefList( Contexte contexte, RefBean bean ) throws TechnicalException {
        try {
            List<ElementWithState> listJointure = (List<ElementWithState>)
                    ...
                    "ModeReservationByTORefDAO", "getAdminRefList",
                    ...
                    new SQLResultSetReader() {
                        public Object instanciateFromLine(ResultSet rs) throws SQLException {
                            ...
                            obj.setCode(StringUtils.trimToEmpty(rs.getString("codeReservationMode")));
            ...
            if( listTO!=null && listTO.size()>0 ) {
                Translator translator = TranslatorFactory.getTranslator(ADMIN_LANGUAGE, true);
    ...
    /**
     * Update la liste des modes de reservation
     * par type offre
     *
     * @param context
     * @param bean
                    ...
                    SQLCallExecuter.getInstance().executeUpdate(
                            ...
                            new SQLParamDescriptorSet(
                                    new SQLParamDescriptor[] {
                                        ...
                                        new SQLParamDescriptor(el.getCode(), Types.VARCHAR),
    ...
    protected String getCacheClassName () {
        return ModeReservationByTOCachList.class.getName();
    }

    protected CachableInterface getObjectInCache (String codeLangue) {
        return (CachableInterface) CacheManager.getInstance().getObjectInCache(ModeReservationByTOCachList.class);
    }
	...
	protected CachableInterface createCacheObject(List<?> data, Contexte contexte) throws TechnicalException, IncoherenceException {
		 return new ModeReservationByTOCachList((List<ParamRefBean>) data);
	}
