...
/**
 * acces direct aux méthodes de log
 * à n'utiliser que dans Commun (d'où le nom différent des autres modules)
 */
public class LogCommun {
   ...
   /**
     ...
     * @param message : liste séparée par des "|" des paramètres
     */
