...
import com.accor.asa.commun.reference.metier.RemunerationTypeCachList;
import com.accor.asa.commun.reference.metier.RemunerationTypeRefBean;
 ...
 * Time: 13:40:20
 */
public class RemunerationTypeRefDAO extends RefDAO {

    private static final String SELECT_PROC_NAME        = "ref_selRemunerationType";
	private static final String ADMIN_SELECT_PROC_NAME  = "ref_selRemunerationType";
	private static final String INSERT_PROC_NAME        = "ref_addRemunerationType";
	private static final String UPDATE_PROC_NAME        = "ref_updRemunerationType";
	private static final String DELETE_PROC_NAME        = "ref_delRemunerationType";
	...
	protected SQLParamDescriptorSet getProcParameters (int type, RefBean bean, String codeLangue) {
		RemunerationTypeRefBean temp = (RemunerationTypeRefBean) bean;
		switch (type) {
			case SELECT :
			...
			case ADMIN_SELECT :
				return new SQLResultSetReader() {
					public Object instanciateFromLine(ResultSet rs) throws TechnicalException, SQLException {
						RemunerationTypeRefBean bean = new RemunerationTypeRefBean();
    ...
    protected String getCacheClassName () {
        return RemunerationTypeCachList.class.getName();
    }

    protected CachableInterface getObjectInCache (String codeLangue) {
        return (CachableInterface) CacheManager.getInstance().getObjectInCache(RemunerationTypeCachList.class, codeLangue);
    }
	...
	protected CachableInterface createCacheObject(List<?> data, Contexte contexte) throws TechnicalException, IncoherenceException {
		 return new RemunerationTypeCachList((List<RemunerationTypeRefBean>) data, contexte.getCodeLangue());
	}
