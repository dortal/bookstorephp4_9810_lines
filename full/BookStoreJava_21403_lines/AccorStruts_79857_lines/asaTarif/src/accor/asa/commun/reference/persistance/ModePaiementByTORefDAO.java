...
import com.accor.asa.commun.reference.metier.ModePaiementByTOCachList;
 ...
 * Time: 15:25:10
 */
public class ModePaiementByTORefDAO extends RefDAO {

    private static final String ADMIN_SELECT_PROC_NAME  = "ref_selPaiementModeByTO";
    private static final String INSERT_PROC_NAME        = "ref_addPaiementModeByTO";
    private static final String DELETE_PROC_NAME        = "ref_delPaiementModeByTO";
	...
	public List<ParamRefBean> getAdminRefList( Contexte contexte, RefBean bean ) throws TechnicalException {
        try {
            List<ElementWithState> listJointure = (List<ElementWithState>) 
                    ...
                    "ModePaiementByTORefDAO", "getAdminRefList",
                    ...
                    new SQLResultSetReader() {
                        public Object instanciateFromLine(ResultSet rs) throws SQLException {
                            ...
                            obj.setCode(StringUtils.trimToEmpty(rs.getString("codePaimentMode")));
    ...
    /**
     * Update la liste des modes de paiements
     * par type offre
     *
     * @param context
     * @param bean
    ...
    protected String getCacheClassName () {
        return ModePaiementByTOCachList.class.getName();
    }

    protected CachableInterface getObjectInCache (String codeLangue) {
        return (CachableInterface) CacheManager.getInstance().getObjectInCache(ModePaiementByTOCachList.class);
    }
	...
	protected CachableInterface createCacheObject( List<?> data, Contexte contexte ) throws TechnicalException, IncoherenceException {
		 return new ModePaiementByTOCachList( (List<ParamRefBean>) data );
	}
